...
void LoadGame::InitializeObject()
{
	...
	this->displayingText.setFillColor(sf::Color::White);
	this->displayingText.setPosition(p2pX(80.0f, vm), p2pY(80.0f, vm));

	this->mapButtons["RETURN"] = new TextButton(p2pX(7.0f, vm), p2pY(8.0f, vm),
		p2pX(15.0f, vm), calcCharSize(vm),
		"RETURN", calcCharSize(vm), sf::Color::Magenta, sf::Color(250, 250, 250, 250), sf::Color(20, 20, 20, 50),
		sf::Color(100, 100, 100, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0), this->ptrGame);

	this->mapButtons["DELETE"] = new TextButton(p2pX(28.0f, vm), p2pY(85.0f, vm),
		p2pX(15.0f, vm), calcCharSize(vm),
		"X", calcCharSize(vm), sf::Color::Red, sf::Color(250, 250, 250, 250), sf::Color(20, 20, 20, 50),
		sf::Color(100, 100, 100, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0), this->ptrGame);

	this->mapButtons["LOAD"] = new TextButton(p2pX(2.0f, vm), p2pY(85.0f, vm),
		p2pX(15.0f, vm), calcCharSize(vm),
	...
	while (this->ptrGame->window->pollEvent(events))
	{
		...
		case sf::Event::MouseButtonPressed:
			if (events.mouseButton.button == sf::Mouse::Left)
			{
				...
				this->displayingText.setPosition(p2pX(23.0f, vm) - (this->displayingText.getGlobalBounds().width / 2.f), p2pY(85.0f, vm));
			}
			break;
		...
		if (this->mapButtons["LOAD"]->GetPressed())
		{
			...
			{
				ptrGame->stateMachine.NewState(std::unique_ptr<StateOfProgram>(new GameLoop(ptrGame,
