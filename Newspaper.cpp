...
{
	this->exitButton = new TextButton(p2pX(20.0f, this->ptrGame->videoMode) + this->centre.x, p2pY(86.0f, this->ptrGame->videoMode) + this->centre.y,
...
void Newspaper::InitializeText()
{
	...
	this->titleText.setCharacterSize(calcCharSize(this->ptrGame->videoMode, 70));
	this->titleText.setString("unknown");
	this->titleText.setPosition(p2pX(55.0f, this->ptrGame->videoMode) - (this->titleText.getGlobalBounds().width / 2.f) + this->centre.x, p2pY(40.0f, this->ptrGame->videoMode) + this->centre.y);
	...
	this->dataText.setPosition(p2pX(55.0f, this->ptrGame->videoMode) - (this->dataText.getGlobalBounds().width / 2.f) + this->centre.x, p2pY(50.0f, this->ptrGame->videoMode) + this->centre.y);
	...
	this->bodyText.setPosition(p2pX(55.0f, this->ptrGame->videoMode) - (this->bodyText.getGlobalBounds().width / 2.f) + this->centre.x, p2pY(60.0f, this->ptrGame->videoMode) + this->centre.y);
}
